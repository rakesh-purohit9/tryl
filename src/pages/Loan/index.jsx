      ...
      <div className="bg-gray_100 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-[20px] md:gap-[20px] items-start mx-[auto] w-[100%]">
        <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[250px]">
          <div className="bg-white_A700 flex flex-col gap-[50px] items-center justify-start py-[30px] w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start mb-[334px] w-[100%]">
              ...
              <div className="flex flex-row gap-[34px] items-center justify-start md:w-[100%] w-[55%]">
        ...
        <div className="flex flex-1 flex-col gap-[31px] items-center justify-start md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-col gap-[24px] items-center justify-start md:w-[100%] w-[94%]">
            ...
            >
              <div className="bg-white_A700 flex flex-1 items-center justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                <div className="flex flex-row gap-[15px] items-center justify-start md:w-[100%] w-[99%]">
                  <Button
              ...
              <div className="bg-white_A700 flex flex-1 items-center justify-start sm:ml-[0] p-[21px] sm:px-[20px] rounded-[25px] w-[100%]">
            ...
            <div className="flex flex-col gap-[15px] items-start justify-start w-[100%]">
              ...
              <div className="bg-white_A700 flex flex-col gap-[12px] items-start justify-end p-[21px] sm:px-[20px] rounded-[25px] w-[100%]">
                <List
                ...
                >
                  <div className="flex flex-col gap-[11px] items-start justify-start w-[100%]">
                    <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start md:w-[100%] w-[94%]">
                      <Text
                        className="font-medium text-bluegray_400 text-left w-[auto]"
                        variant="body1"
                      >
                  ...
                  <div className="flex flex-col md:gap-[15px] items-center justify-center w-[100%]">
                    <div className="flex flex-col gap-[14px] items-center justify-start mt-[15px] md:w-[100%] w-[63%]">
                      <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start rounded-[17.5px] md:w-[100%] w-[99%]">
                        <Text
                        ...
                        <Text
                          className="font-normal md:ml-[0] ml-[96px] not-italic text-bluegray_900 text-left w-[auto]"
                          variant="body1"
                        >
                          $40,500
                        </Text>
                    ...
                    <div className="flex flex-col gap-[14px] items-center justify-start md:w-[100%] w-[63%]">
                      <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start rounded-[17.5px] md:w-[100%] w-[99%]">
                        <Text
                          className="font-normal not-italic text-bluegray_900 text-left w-[auto]"
                          variant="body1"
                ...
                <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start md:ml-[0] ml-[9px] mr-[auto] md:w-[100%] w-[84%]">
                  <Text
