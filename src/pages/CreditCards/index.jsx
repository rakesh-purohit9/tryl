          ...
          <div className="flex flex-col items-center justify-start md:w-[100%] w-[94%]">
            <div className="flex flex-col gap-[19px] items-start justify-start w-[100%]">
              ...
              <div className="gap-[30px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between w-[100%]">
                <CreditCardItem className="bg-indigo_600 flex flex-1 flex-col items-center justify-end pt-[24px] rounded-[25px] w-[100%]" />
                <CreditCardItem className="bg-indigo_500 flex flex-1 flex-col items-center justify-end pt-[24px] rounded-[25px] w-[100%]" />
                <CreditCardItem className="bg-indigo_300 border-[1px] border-gray_103 border-solid flex flex-1 flex-col items-center justify-end pt-[24px] rounded-[25px] w-[100%]" />
              </div>
            </div>
