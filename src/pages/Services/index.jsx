        ...
        <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[250px]">
          <div className="bg-white_A700 flex flex-col gap-[50px] items-center justify-start py-[30px] w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start mb-[334px] w-[100%]">
              ...
              <div className="flex flex-row gap-[34px] items-center justify-start md:w-[100%] w-[64%]">
          ...
          <div className="flex flex-col gap-[24px] items-center justify-start md:w-[100%] w-[94%]">
            ...
            >
              <div className="bg-white_A700 flex flex-1 items-start justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                <div className="flex flex-row gap-[22px] items-center justify-start md:w-[100%] w-[82%]">
                  <Button
              ...
              <div className="bg-white_A700 flex flex-1 items-start justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                <div className="flex flex-row gap-[22px] items-center justify-start md:w-[100%] w-[75%]">
                  <Button
                    className="flex h-[70px] items-center justify-center rounded-[50%] w-[70px]"
                    size="xlIcn"
                    variant="icbFillGray102"
            ...
            <div className="flex flex-col gap-[28px] items-start justify-start w-[100%]">
              ...
              >
                <div className="bg-white_A700 flex flex-1 md:flex-col flex-row md:gap-[20px] items-center justify-start p-[15px] rounded-[20px] w-[100%]">
                  ...
                  <div className="flex md:flex-1 flex-col gap-[7px] items-start justify-start md:ml-[0] ml-[20px] md:w-[100%] w-[auto]">
                    <Text
                  ...
                  <div className="flex md:flex-1 flex-col gap-[7px] items-start justify-start md:ml-[0] ml-[85px] md:w-[100%] w-[auto]">
                    <Text
                      className="font-medium text-bluegray_900 text-left w-[auto]"
                      variant="body1"
                    >
                  ...
                  <div className="flex md:flex-1 flex-col gap-[7px] items-start justify-start md:ml-[0] ml-[82px] md:w-[100%] w-[auto]">
                    <Text
                      className="font-medium text-bluegray_900 text-left w-[auto]"
                      variant="body1"
                    >
                  ...
                  <Button
                    className="cursor-pointer font-medium leading-[normal] min-w-[150px] md:ml-[0] ml-[80px] text-[15px] text-center text-indigo_500 w-[auto]"
                ...
                <div className="bg-white_A700 flex flex-1 md:flex-col flex-row md:gap-[20px] items-center justify-start p-[15px] rounded-[20px] w-[100%]">
                  ...
                  <div className="flex md:flex-1 flex-col gap-[7px] items-start justify-start md:ml-[0] ml-[73px] md:w-[100%] w-[auto]">
                    <Text
                      className="font-medium text-bluegray_900 text-left w-[auto]"
                      variant="body1"
                    >
