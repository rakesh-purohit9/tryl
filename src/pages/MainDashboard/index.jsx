    ...
    <>
      <div className="bg-gray_100 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-[20px] md:gap-[20px] items-start mx-[auto] pb-[30px] w-[100%]">
        <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[250px]">
          <div className="bg-colors flex flex-col gap-[50px] items-center justify-start mb-[364px] mt-[30px] w-[100%]">
            <Img
              src="images/img_logo.png"
              className="h-[40px] md:h-[auto] object-cover w-[65%]"
              alt="Logo"
            />
            <div className="flex flex-col items-start justify-start w-[100%]">
              <div className="flex flex-row gap-[34px] items-center justify-start md:w-[100%] w-[72%]">
        ...
        <div className="flex flex-1 flex-col gap-[25px] items-center justify-start md:px-[20px] w-[100%]">
          <div className="bg-colors1 border-[1px] border-gray_300 border-solid flex md:flex-col flex-row md:gap-[20px] items-center justify-start p-[20px] w-[100%]">
            <Text
            ...
            <Input
              ...
              prefix={
                <Img
                  ...
                  className="cursor-pointer ml-[25px] mr-[15px] my-[auto]"
                  alt="search"
                />
              }
              suffix={
          ...
          <div className="flex flex-col gap-[24px] items-center justify-start md:w-[100%] w-[94%]">
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
              <div className="flex md:flex-1 items-center justify-start md:w-[100%] w-[66%]">
                <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
                  ...
                  <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
                    <CreditCardItem
                      className="common-pointer bg-indigo_600 flex md:flex-1 flex-col items-center justify-end pt-[24px] rounded-[25px] md:w-[100%] w-[auto]"
                      onClick={() => {
                      ...
                      price="$5,756"
                    />
                    <CreditCardItem className="bg-indigo_500 flex md:flex-1 flex-col items-center justify-end pt-[24px] rounded-[25px] md:w-[100%] w-[auto]" />
                  </div>
                </div>
              </div>
              <div className="flex md:flex-1 flex-col gap-[20px] items-start justify-start md:w-[100%] w-[32%]">
                ...
                <List
                  className="bg-white_A700 flex-col gap-[10px] grid items-center p-[24px] sm:px-[20px] rounded-[25px] w-[100%]"
            ...
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
              <div className="flex md:flex-1 flex-col gap-[18px] items-start justify-start md:w-[100%] w-[66%]">
                <Text
                  className="text-bluegray_900 text-left w-[auto]"
                  as="h3"
                  variant="h3"
                ...
                <div className="bg-white_A700 flex flex-col gap-[22px] items-end justify-start p-[28px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="flex flex-row gap-[30px] items-center justify-end ml-[auto] md:w-[100%] w-[30%]">
                  ...
                  <div className="flex items-center justify-start mr-[2px] md:w-[100%] w-[99%]">
                    <div className="flex flex-col gap-[9px] justify-start w-[100%]">
                      <div className="flex md:flex-col flex-row gap-[10px] items-center justify-between w-[100%]">
                        <div className="flex md:flex-1 flex-col gap-[21px] items-start justify-start md:w-[100%] w-[auto]">
                          <Text
                            className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                            variant="body4"
                          >
                          ...
                          <Text
                            className="font-normal md:ml-[0] ml-[14px] not-italic text-bluegray_400 text-left w-[auto]"
                            variant="body4"
                          >
                            0
                          </Text>
                      ...
                      <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-end ml-[auto] md:w-[100%] w-[84%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
              ...
              <div className="flex md:flex-1 flex-col gap-[18px] items-start justify-start md:w-[100%] w-[32%]">
                <Text
                  className="text-bluegray_900 text-left w-[auto]"
                  as="h3"
                  variant="h3"
                ...
                <div className="bg-white_A700 flex items-center justify-start p-[31px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="md:h-[189px] h-[259px] relative w-[94%]">
                    <div
                      className="absolute bg-cover bg-no-repeat flex h-[129px] items-center justify-start left-[7%] p-[33px] sm:px-[20px] top-[0] w-[auto]"
                      style={{
                    ...
                    <div
                      className="absolute bg-cover bg-no-repeat bottom-[4%] flex h-[189px] items-center justify-start left-[0] p-[14px] w-[auto]"
                      style={{
                    ...
                    <div
                      className="absolute bg-cover bg-no-repeat flex h-[102px] items-end justify-end p-[6px] right-[0] top-[11%] w-[auto]"
                      style={{
                    ...
                    <div className="absolute bg-indigo_200 bottom-[0] flex h-[119px] items-center justify-start p-[23px] sm:px-[20px] right-[12%] w-[119px]">
                      <Text
            ...
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
              <div className="flex md:flex-1 flex-col gap-[20px] items-start justify-start md:w-[100%] w-[41%]">
                <Text
                ...
                <div className="bg-white_A700 flex flex-col gap-[29px] items-center justify-center p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="flex sm:flex-col flex-row gap-[33px] items-center justify-between mt-[10px] w-[100%]">
                    ...
                    <Button
                      className="flex h-[50px] items-center justify-center mb-[36px] sm:mt-[0] mt-[41px] rounded-[50%] w-[50px]"
                      size="mdIcn"
                  ...
                  <div className="flex sm:flex-col flex-row gap-[27px] items-center justify-between mb-[10px] w-[100%]">
                    ...
                    <div className="bg-gray_102 flex sm:flex-1 flex-row items-center justify-between sm:pl-[20px] pl-[30px] rounded-[25px] sm:w-[100%] w-[68%]">
                      <Text
                        className="font-bold text-indigo_700 text-left w-[auto]"
                        variant="body1"
                      >
              ...
              <div className="flex md:flex-1 flex-col gap-[20px] items-start justify-start md:w-[100%] w-[58%]">
                <Text
                  className="text-bluegray_900 text-left w-[auto]"
                  as="h3"
                  variant="h3"
                ...
                <div className="bg-white_A700 md:h-[206px] h-[276px] p-[20px] relative rounded-[25px] w-[100%]">
                  <Img
                    src="images/img_group.svg"
                    className="h-[185px] ml-[auto] mr-[5px] mt-[15px] w-[87%]"
                    alt="Group"
                  />
                  <div className="absolute md:h-[206px] h-[216px] inset-[0] justify-center m-[auto] sm:w-[100%] w-[93%]">
                    <div className="absolute flex flex-col items-start justify-start left-[0] pl-[3px] top-[0] w-[8%]">
                      <div className="flex flex-row gap-[8px] items-end justify-between ml-[auto] md:w-[100%] w-[95%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
                      ...
                      <div className="flex flex-row gap-[8px] items-end justify-between ml-[auto] mt-[35px] md:w-[100%] w-[95%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
                      ...
                      <div className="flex flex-row gap-[8px] items-end justify-between ml-[auto] mt-[36px] md:w-[100%] w-[98%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
                      ...
                      <div className="flex flex-row gap-[8px] items-start justify-between ml-[auto] mt-[35px] md:w-[100%] w-[93%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
                      ...
                      <div className="flex flex-row gap-[9px] items-start justify-end ml-[auto] mt-[34px] md:w-[100%] w-[56%]">
                        <Text
                    ...
                    <div className="absolute bottom-[0] flex flex-col items-start justify-start right-[0] w-[93%]">
                      <Img
                        ...
                        className="h-[177px] md:h-[auto] object-cover w-[100%]"
                        alt="Vector Five"
                      />
                      <div className="flex items-center justify-start mt-[4px] md:w-[100%] w-[91%]">
                        <div className="flex flex-col items-start justify-start w-[100%]">
                          <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-start md:w-[100%] w-[95%]">
                            <Img
