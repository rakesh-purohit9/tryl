      ...
      <div className="bg-gray_100 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-[20px] md:gap-[20px] items-start mx-[auto] w-[100%]">
        <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[250px]">
          <div className="bg-white_A700 flex flex-col gap-[50px] items-center justify-start py-[30px] w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start mb-[334px] w-[100%]">
              ...
              <div className="flex flex-row gap-[34px] items-center justify-start md:w-[100%] w-[77%]">
        ...
        <div className="flex flex-1 flex-col gap-[31px] items-center justify-start md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-col gap-[24px] items-center justify-start md:w-[100%] w-[94%]">
            ...
            >
              <div className="bg-white_A700 flex flex-1 items-start justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
              ...
              <div className="bg-white_A700 flex flex-1 items-start justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                <div className="flex flex-row gap-[15px] items-center justify-start md:w-[100%] w-[88%]">
                  <Button
                    className="flex h-[70px] items-center justify-center rounded-[50%] w-[70px]"
                    size="xlIcn"
                    variant="icbFillGray102"
              ...
              <div className="bg-white_A700 flex flex-1 items-start justify-start sm:ml-[0] p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                <div className="flex flex-row gap-[15px] items-center justify-start md:w-[100%] w-[65%]">
                  <Button
                    className="flex h-[70px] items-center justify-center rounded-[50%] w-[70px]"
                    size="xlIcn"
                    variant="icbFillGray102"
            ...
            >
              <div className="flex flex-1 flex-col gap-[20px] items-start justify-start w-[100%]">
                ...
                <div className="bg-white_A700 flex items-center justify-start p-[26px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="flex sm:flex-col flex-row gap-[9px] items-start justify-start mb-[2px] md:w-[100%] w-[99%]">
                    <div className="flex flex-col gap-[32px] items-start justify-start sm:w-[100%] w-[auto]">
                      ...
                      <Text
                        className="font-normal h-[16px] md:ml-[0] ml-[35px] not-italic text-bluegray_400 text-left w-[auto]"
                        variant="body4"
                      >
                        $0
                      </Text>
                    ...
                    <div className="flex flex-col items-center justify-start sm:mt-[0] mt-[14px] sm:w-[100%] w-[88%]">
                      <div className="border-[1px] border-dashed border-gray_103 h-[1px] w-[100%]"></div>
                      <div className="h-[161px] md:h-[167px] mt-[6px] relative w-[100%]">
                        <div className="absolute bottom-[14%] flex inset-x-[0] items-center justify-start mx-[auto] w-[100%]">
                      ...
                      <div className="border-[1px] border-dashed border-gray_103 h-[1px] mt-[22px] w-[100%]"></div>
                      <div className="flex flex-row items-center justify-between mt-[7px] md:w-[100%] w-[96%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
              ...
              <div className="flex flex-1 flex-col gap-[20px] items-start justify-start w-[100%]">
                ...
                <div className="bg-white_A700 flex items-center justify-start p-[26px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="flex sm:flex-col flex-row gap-[9px] items-start justify-start mb-[2px] md:w-[100%] w-[99%]">
                    ...
                    <div className="flex flex-col items-center justify-start sm:mt-[0] mt-[14px] sm:w-[100%] w-[88%]">
                      <div className="border-[1px] border-dashed border-gray_103 h-[1px] w-[100%]"></div>
                      <div className="h-[111px] md:h-[136px] mt-[25px] relative w-[100%]">
                        <div className="absolute flex inset-x-[0] items-center justify-start mx-[auto] top-[20%] w-[100%]">
                          <div className="flex flex-col gap-[47px] items-center justify-start w-[100%]">
                            <div className="border-[1px] border-dashed border-gray_103 h-[1px] w-[100%]"></div>
                            <div className="border-[1px] border-dashed border-gray_103 h-[1px] w-[100%]"></div>
                          </div>
                      ...
                      <div className="border-[1px] border-dashed border-gray_103 h-[1px] mt-[7px] w-[100%]"></div>
                      <div className="border-[1px] border-dashed border-gray_103 h-[1px] mt-[45px] w-[100%]"></div>
                      <div className="flex flex-row items-center justify-between mt-[7px] md:w-[100%] w-[97%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                          variant="body4"
                        >
            ...
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[100%]">
              <div className="flex md:flex-1 flex-col gap-[18px] items-start justify-start md:w-[100%] w-[58%]">
                <Text
                  className="text-bluegray_900 text-left w-[auto]"
                  as="h3"
                  variant="h3"
                ...
                >
                  <div className="bg-white_A700 flex flex-1 sm:flex-col flex-row sm:gap-[20px] items-center justify-start p-[15px] rounded-[20px] w-[100%]">
                    <Button
                    ...
                    <div className="flex sm:flex-1 flex-col gap-[7px] items-start justify-start sm:ml-[0] ml-[20px] sm:w-[100%] w-[auto]">
                      <Text
                    ...
                    <div className="flex sm:flex-1 flex-col gap-[7px] items-start justify-start sm:ml-[0] ml-[56px] sm:w-[100%] w-[auto]">
                      <Text
                        className="font-medium text-bluegray_900 text-left w-[auto]"
                        variant="body1"
                      >
                    ...
                    <div className="flex sm:flex-1 flex-col gap-[7px] items-start justify-start sm:ml-[0] ml-[44px] sm:w-[100%] w-[auto]">
                      <Text
                  ...
                  <div className="bg-white_A700 flex flex-1 sm:flex-col flex-row sm:gap-[20px] items-center justify-start p-[15px] rounded-[20px] w-[100%]">
                    ...
                    <div className="flex sm:flex-1 flex-col gap-[7px] items-start justify-start sm:ml-[0] ml-[127px] sm:w-[100%] w-[auto]">
                      <Text
                        className="font-medium text-bluegray_900 text-left w-[auto]"
                        variant="body1"
                      >
              ...
              <div className="flex md:flex-1 flex-col gap-[18px] items-start justify-start md:w-[100%] w-[41%]">
                <Text
                  className="text-bluegray_900 text-left w-[auto]"
                  as="h3"
                  variant="h3"
                ...
                <div className="bg-white_A700 flex flex-col gap-[13px] items-start justify-end p-[25px] sm:px-[20px] rounded-[25px] w-[100%]">
                  <div className="flex flex-col gap-[8px] items-start justify-start md:ml-[0] ml-[5px] mt-[2px] md:w-[100%] w-[98%]">
                  ...
                  <List
                    className="flex-col gap-[28px] grid md:ml-[0] ml-[5px] w-[91%]"
                    orientation="vertical"
                  >
                    ...
                    <div className="flex flex-row items-center justify-start md:w-[100%] w-[98%]">
                      <Text
                        className="font-normal not-italic text-bluegray_900 text-left w-[auto]"
                        variant="body1"
                      >
                    ...
                    <div className="flex flex-row items-center justify-start md:w-[100%] w-[99%]">
                      <Text
                        className="font-normal not-italic text-bluegray_900 text-left w-[auto]"
                        variant="body1"
                      >
